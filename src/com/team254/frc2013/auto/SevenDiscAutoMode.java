...
public class SevenDiscAutoMode extends CommandGroup {
  public SevenDiscAutoMode() {
    ...
    addSequential(new DriveAtSpeedCommand(0.2, 0.5, 0, 5));
    addSequential(new DriveAtSpeedCommand(1.5, 0.25, 0, 5));
    addSequential(new ShooterPresetCommand(Shooter.PRESET_FRONT_PYRAMID));
    addSequential(new DriveAtSpeedCommand(6, 0.5, 0, 5));
    addSequential(new DriveAtSpeedCommand(7, 0.25, 0, 5));
    addSequential(new AutonIndexerCommand());
    addSequential(new DriveAtSpeedCommand(11.5, 0.25, 0, 5));
